window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a rightangle triangle requires the length of the two different sides of the triangle. Try again.')
		else if ( b !== 'float' )
			...
			alert('Incorrect formula for calculating the area of a right angle. Try again.')
		else
